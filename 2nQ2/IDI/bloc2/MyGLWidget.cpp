...
void MyGLWidget::modelTransformPatricio1 ()
{
  ...
  transform = glm::rotate(transform, rot, glm::vec3(0.0, 1.0, 0.0));
...
void MyGLWidget::modelTransformPatricio2 ()
{
  // Matriu de transformació de model
  glm::mat4 transform (1.0f);
  transform = glm::rotate(transform, rot+float(M_PI/2.0), glm::vec3(0.0, 1.0, 0.0));
  transform = glm::scale(transform, glm::vec3(scale));
  transform = glm::scale(transform, glm::vec3(scale));
  transform = glm::translate(transform, -centreBasePatricio);
  glUniformMatrix4fv(transLoc, 1, GL_FALSE, &transform[0][0]);
...
void MyGLWidget::modelTransformPatricio3 ()
{
  // Matriu de transformació de model
  glm::mat4 transform (1.0f);
  transform = glm::rotate(transform, rot+float(M_PI), glm::vec3(0.0, 1.0, 0.0));
  transform = glm::scale(transform, glm::vec3(scale));
