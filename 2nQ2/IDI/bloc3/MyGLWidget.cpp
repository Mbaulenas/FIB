...
void MyGLWidget::initializeGL ()
{
  ...
  glm::vec3 posFocus = glm::vec3(xpatr,0.5,zpatr); //si x = posX, amb k i l movem el focus
  glUniform3fv(posFocusLoc, 1, &posFocus[0]);

  glm::vec3 colFocus = glm::vec3(0.8, 0.8, 0.8);
  glUniform3fv(colFocusLoc, 1, &colFocus[0]);

  glUniform1i(canviLoc, canvi);
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::translate(TG, -glm::vec3(xpatr,0.85,zpatr));
...
void MyGLWidget::keyPressEvent(QKeyEvent* event)
{
  ...
  switch (event->key()) {
    ...
    case Qt::Key_K: { // canvia òptica entre perspectiva i axonomètrica
      posx +=0.2;
      glm::vec3 posFocus = glm::vec3(posx,1,1);
      glUniform3fv(posFocusLoc, 1, &posFocus[0]);
      break;
    }
    case Qt::Key_L: { // canvia òptica entre perspectiva i axonomètrica
      glm::vec3 colFocus;
      fosc = !fosc;
      if(!fosc)  colFocus = glm::vec3(0.8, 0.8, 0.8);
    ...
    case Qt::Key_F: { // canvia òptica entre perspectiva i axonomètrica
      ...
      if (canvi){
        ...
        glm::vec3 PosFocus = glm::vec3(1,0.5,1);
        glUniform3fv(posFocusLoc, 1, &PosFocus[0]);
      }
      break;
    }
...
void MyGLWidget::carregaShaders()
{
  ...
  canviLoc = glGetUniformLocation(program->programId(), "canvi");
