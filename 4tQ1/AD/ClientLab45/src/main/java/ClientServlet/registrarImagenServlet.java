...
public class registrarImagenServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet registrarImagenServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet registrarImagenServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        try(PrintWriter out = response.getWriter()){
            ...
            if (misesion != null){
                ...
                if(misesion.getAttribute("username") != null){
                    ...
                    String aux = "http://localhost:8080/lab4AD/resources/javaee8/register";
    ...
    public void Upload(byte[] imageBytes, String filename){
            ...
            try{
                String aux = "http://localhost:8080/lab4AD/resources/javaee8/upload";
